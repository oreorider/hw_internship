...
#
# Generated by export_simulation on Wed Nov 08 13:08:04 +0900 2023
#
################################################################################
...
'-reset_run' switch to the './layer2_line_buffer_192x32.sh' script.

./layer2_line_buffer_192x32.sh -reset_run
...
./layer2_line_buffer_192x32.sh -noclean_files

For more information on the script, please type './layer2_line_buffer_192x32.sh -help'.
