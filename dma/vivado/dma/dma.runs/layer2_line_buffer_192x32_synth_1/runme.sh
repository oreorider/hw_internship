...
HD_PWD='C:/Users/Young Jae/OneDrive - SNU/maskgenFPGA/dfx/ip/dma/vivado/dma/dma.runs/layer2_line_buffer_192x32_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log layer2_line_buffer_192x32.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source layer2_line_buffer_192x32.tcl
