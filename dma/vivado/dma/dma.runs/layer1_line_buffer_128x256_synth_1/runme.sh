...
HD_PWD='C:/Users/Young Jae/OneDrive - SNU/maskgenFPGA/dfx/ip/dma/vivado/dma/dma.runs/layer1_line_buffer_128x256_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log layer1_line_buffer_128x256.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source layer1_line_buffer_128x256.tcl
