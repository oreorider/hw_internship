...
HD_PWD='C:/Users/Young Jae/OneDrive - SNU/maskgenFPGA/dfx/ip/dma/vivado/dma/dma.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cnn_dma_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cnn_dma_wrapper.tcl
