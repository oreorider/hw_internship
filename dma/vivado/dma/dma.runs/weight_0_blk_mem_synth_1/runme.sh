...
HD_PWD='C:/Users/Young Jae/OneDrive - SNU/maskgenFPGA/dfx/ip/dma/vivado/dma/dma.runs/weight_0_blk_mem_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log weight_0_blk_mem.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source weight_0_blk_mem.tcl
