...
HD_PWD='C:/Users/Young Jae/OneDrive - SNU/maskgenFPGA/dfx/ip/dma/vivado/dma/dma.runs/axilite_clock_converter_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axilite_clock_converter_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axilite_clock_converter_0.tcl
