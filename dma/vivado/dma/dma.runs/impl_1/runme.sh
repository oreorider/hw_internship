...
HD_PWD='C:/Users/Young Jae/OneDrive - SNU/maskgenFPGA/dfx/ip/dma/vivado/dma/dma.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log cnn_dma_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source cnn_dma_wrapper.tcl -notrace
