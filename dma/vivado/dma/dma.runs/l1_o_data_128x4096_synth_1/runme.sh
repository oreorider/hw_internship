...
HD_PWD='C:/Users/Young Jae/OneDrive - SNU/maskgenFPGA/dfx/ip/dma/vivado/dma/dma.runs/l1_o_data_128x4096_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log l1_o_data_128x4096.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source l1_o_data_128x4096.tcl
