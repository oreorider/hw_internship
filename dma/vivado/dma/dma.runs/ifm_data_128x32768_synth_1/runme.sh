...
HD_PWD='C:/Users/Young Jae/OneDrive - SNU/maskgenFPGA/dfx/ip/dma/vivado/dma/dma.runs/ifm_data_128x32768_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ifm_data_128x32768.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ifm_data_128x32768.tcl
