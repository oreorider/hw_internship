...
## Clock Signal
set_property -dict { PACKAGE_PIN R4    IOSTANDARD LVCMOS33 } [get_ports { ap_clk }]; #IO_L13P_T2_MRCC_34 Sch=sysclk
...
set_property -dict { PACKAGE_PIN G4  IOSTANDARD LVCMOS15 } [get_ports { ap_rst_n }]; #IO_L12N_T1_MRCC_35 Sch=cpu_resetn
