...
for ch = 1:4
    ...
    im_sw = imread(sprintf('./out_sw/m1/ofmap_L08_ch%02d.bmp',ch));
    % Output from the H/W simulation
    %im_hw = imread(sprintf('wdatafile/convout_layer01_ch%02d.bmp',ch));
    im_hw = imread(sprintf('./wdatafile/convout_ch%02d.bmp',ch));
